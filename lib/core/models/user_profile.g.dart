...
extension UserProfileByIndex on IsarCollection<UserProfile> {
  ...
  List<Id> putAllByEmailSync(List<UserProfile> objects,
      {bool saveLinks = true}) {
...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsElementEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsElementStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsElementEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsElementContains(String value,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
        property: r'favoriteMovieIds',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsElementMatches(String pattern,
          {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
        property: r'favoriteMovieIds',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsLengthLessThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
      favoriteMovieIdsLengthGreaterThan(
    int length, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
