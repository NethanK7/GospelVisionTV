...
const UserProfileSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'favoriteMovieIds': PropertySchema(
      id: 2,
      name: r'favoriteMovieIds',
...
int _userProfileEstimateSize(
  ...
  bytesCount += 3 + object.favoriteMovieIds.length * 3;
  {
    for (var i = 0; i < object.favoriteMovieIds.length; i++) {
      final value = object.favoriteMovieIds[i];
...
void _userProfileSerialize(
  ...
  writer.writeStringList(offsets[2], object.favoriteMovieIds);
}
...
UserProfile _userProfileDeserialize(
  ...
  object.favoriteMovieIds = reader.readStringList(offsets[2]) ?? [];
  object.id = id;
  return object;
}
...
extension UserProfileByIndex on IsarCollection<UserProfile> {
  ...
  UserProfile? getByEmailSync(String email) {
  ...
  Future<List<UserProfile?>> getAllByEmail(List<String> emailValues) {
    final values = emailValues.map((e) => [e]).toList();
    return getAllByIndex(r'email', values);
  }

  List<UserProfile?> getAllByEmailSync(List<String> emailValues) {
    final values = emailValues.map((e) => [e]).toList();
  ...
  Future<Id> putByEmail(UserProfile object) {
    return putByIndex(r'email', object);
  }

  Id putByEmailSync(UserProfile object, {bool saveLinks = true}) {
    return putByIndexSync(r'email', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByEmail(List<UserProfile> objects) {
...
extension UserProfileQueryWhere
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterWhereClause> emailEqualTo(
    String email,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterWhereClause> emailNotEqualTo(
    String email,
  ) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementEqualTo(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(
          property: r'favoriteMovieIds',
          value: value,
          caseSensitive: caseSensitive,
        ),
      );
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementStartsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.startsWith(
          property: r'favoriteMovieIds',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementEndsWith(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.endsWith(
          property: r'favoriteMovieIds',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementContains(String value, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.contains(
          property: r'favoriteMovieIds',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementMatches(String pattern, {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.matches(
          property: r'favoriteMovieIds',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'favoriteMovieIds', value: ''),
      );
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsElementIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(property: r'favoriteMovieIds', value: ''),
      );
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsLengthEqualTo(int length) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'favoriteMovieIds', length, true, length, true);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'favoriteMovieIds', 0, true, 0, true);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'favoriteMovieIds', 0, false, 999999, true);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsLengthLessThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.listLength(r'favoriteMovieIds', 0, true, length, include);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition>
  favoriteMovieIdsLengthGreaterThan(int length, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryWhereDistinct
  ...
  distinctByFavoriteMovieIds() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'favoriteMovieIds');
    });
  }
}
...
extension UserProfileQueryProperty
  ...
  favoriteMovieIdsProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'favoriteMovieIds');
    });
  }
}
